...
export default /*#__PURE__*/Vue.extend({
  name: 'VueDragAndDropBuilderSample', // vue component name
  data(): SampleData {
    return {
      counter: 5,
      initCounter: 5,
...
<template>
  <div class="vue-drag-and-drop-builder-sample">
...
<style scoped>
  .vue-drag-and-drop-builder-sample {
    display: block;
    width: 400px;
    margin: 25px auto;
  ...
  .vue-drag-and-drop-builder-sample p {
    margin: 0 0 1em;
  }
</style>
